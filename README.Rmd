...
bibliography: vignettes/eesim_bibfile.bib
---
...
Once the expected count ($\lambda_t$) on each day of the simulated time series is calculated using this equation, the simulated count on each day is drawn as a random variable from a Poisson distribution with mean $\lambda_t$. Later we describe how customization can be used to simulate output counts in other ways.
