...
power_calc(varying = "n", values = c(5, 10, 25), n_reps = 3, central = 100, sd=10, exposure_type = "continuous", exposure_trend = "cos1", exposure_amp = .6, average_outcome=22, outcome_trend = "no trend", outcome_amp = .6, rr=1.1, start.date = "2000-01-01")
```
