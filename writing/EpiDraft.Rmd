...
```{r}
power_calc(varying = "n", values = c(365*1:3), simargs = list(n_reps = 10,
           rr = 1.5, central = 50, sd = 5, exposure_trend = "no trend",
