...
leg1 <- read.csv("../Legionnaires data/2014Leg.csv")[,c(2,3,24)]
leg2 <- read.csv("../Legionnaires data/2015Leg.csv")[,c(2,3,24)]
leg3 <- read.csv("../Legionnaires data/2016Leg.csv")[,c(2,3,24)]
...
pamonthly <- group_by(parain, month, year) %>% summarise(quant75 =mean(quant75), quant95=mean(quant95), quant99=mean(quant99))
nymonthly <- group_by(nyrain, month, year) %>% summarise(mean(quant75), mean(quant95), mean(quant99))
