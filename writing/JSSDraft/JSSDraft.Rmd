...
* Statistical power to detect a true effect of a certain size (percent of simulations in which a true effect of a certain size is identified with a p-value of 0.05 or lower; i.e., probability of rejecting the null hypothesis when the null hypothesis is false) \citep{Bellan2015, Johnson2015}
* Precision of effect estimate (average confidence interval width over all simulations) \citep{Johnson2015}
* 95% confidence inverval coverage (percent of 95% confidence intervals from simulations that include the true effect size) \citep{Johnson2015}
* Bias in effect estimate \citep{Johnson2015}
* Margin of error [?] \citep{Johnson2015}
* Sample size required to detect a certain effect size \citep{Burton2009}
