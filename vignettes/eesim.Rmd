...
### Customizing the exposure simulation

There are two ways to customize the exposure simulation: creating a custom trend for exposure values to follow and customizing the way in which exposure values are randomized from a trend line.

Here is an example of using a custom function to specify an exposure trend that is not built in to eesim using the `cust_exp_func` argument. All arguments for this user-created trend function are entered as a list in the `cust_exp_args` argument.
